...
public class InputDati {
    ...
    private final static String ERRORE_MINIMO_MASSIMO = "Attenzione: è richiesto un valore compreso tra %d e %d";
    ...
    public static int leggiInteroConMinimoMassimo(String messaggio, int min, int max) {
	  	boolean finito = false;
	  	int valoreLetto = 0;
	  	do{
	  	    ...
	  	    if(valoreLetto >= min && valoreLetto <= max)
                ...
                System.out.printf(ERRORE_MINIMO_MASSIMO + "\n", min, max);
        }while(!finito);
